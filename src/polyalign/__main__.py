...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 5:
        print("Usage: python3 -m polyalign [filtered|paired] <reference.fasta> <reads_1.fastq> <reads_2.fastq> <output_basename>")
        print("", "Output will be <output_basename>_1.sam and <output_basename>_2.sam in filtered mode or <output_basename>.sam in paired mode.")
